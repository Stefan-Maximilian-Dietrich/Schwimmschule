        ...
        <div class="grid align__item">
            ...
            <div class="register">
                ...
                <form action="rabatt.php" method="post">
                    ...
                    <h3>Zeitblock 1 - VORMITTAGS - jede Uhrzeit 2,5% Rabatt</h3>
                    <label class="container">
                    ...
                    <h3>Zeitblock 1 - RANDZEITEN - jede Uhrzeit 1,5% Rabatt</h3>
                    <label class="container">
                    ...
                    <h3>Zeitblock 1 - HIGH-PEAK-ZEITEN - jede Uhrzeit 0,5% Rabatt</h3>
                    <label class="container">
                    ...
                    <h3>Zeitblock 2 - VORMITTAGS - jede Uhrzeit 2,5% Rabatt</h3>
                    <label class="container">
                    ...
                    <h3>Zeitblock 2 - RANDZEITEN - jede Uhrzeit 1,5% Rabatt</h3>
                    <label class="container">
                    ...
                    <h3>Zeitblock 2 - HIGH-PEAK-ZEITEN - jede Uhrzeit 0,5% Rabatt</h3>
                    <label class="container">
                ...
                ?>
                    <meta http-equiv="refresh" content="0; URL = bezahlen.php" />
                <?php
